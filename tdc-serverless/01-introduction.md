...
- Serverless: Funções Lambda + API Gateway
- Terraform Banco de Dados, Filas, Permissões, Network, etc.
...
- :question: Implementar autenticação
- :question: Usar Lambda custom authorizer
- :thumbsup: Usar API keys do API Gateway

---

^ Note: Due to a CloudFormation restriction you need to wire up API Keys and usage plans manually in the AWS console.
^ https://github.com/serverless/serverless/blob/d4e276d149a89eef184ee48428f2a0d89154416f/docs/providers/aws/events/apigateway.md#setting-api-keys-for-your-rest-api
...
- Role (`terraform`) :point_right: Lambda (`serverless`)
- Lambda (`serverless`) :point_right: API Gateway (`terraform`)
...
- Criar as Lambdas com Terraform
- Usar Serverless para deployar as funções

---

### Problema 6

## Serverless não atualiza funções já existentes
